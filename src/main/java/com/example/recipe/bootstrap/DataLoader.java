...
public class DataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        // (in all Optional's cases, RuntimeException thrown if Optional.isEmpty())
        ...
        if(!cupUomOptional.isPresent()){
            throw new RuntimeException("Expected UOM Not 'cup' Found");
        }

        //assign each DB unitOfMeasure's to Java POJO
        ...
        // similarly, build up optionals and Category's of American and Mexican, then assign to POJOs
        ...
        // Start with the Guacamole recipe, build Recipe primitives (composition handled afterwards)
        ...
        // build composition variables: Category, Notes and Ingredients
...
//        guacRecipe.setNotes(guacNotes);
        //cleaner version of above (setNotes() implements association)
        guacRecipe.setNotes(guacNotes);

//        guacRecipe.getIngredients().add(new Ingredient("ripe avocados", new BigDecimal(2), eachUom, guacRecipe));
        //cleaner version of above (using the more concise three-argument constructor)
        ...
        //add GuacRecipe to recipes ArrayList
